...
the [pre-check/post-check hooks](https://todd2982.dev/watchtower/lifecycle-hooks/), but will __not__ update the
containers.
...
For details see [HTTP API](https://todd2982.dev/watchtower/http-api-mode).
...
This enables [running multiple instances](https://todd2982.dev/watchtower/running-multiple-instances).
